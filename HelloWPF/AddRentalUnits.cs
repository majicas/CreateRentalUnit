                ...
                if (File.Exists(fileName))
                {
                    ...
                    try
                    {
                        for (int i = 1; i < rowCount; i++)
                        {
                            ...
                            {
                                case "Apartment":
                                    IWebElement apartmentbuilding = waiting.Until(x => x.FindElement(By.Id("ctl00_body_InputForm_BuildingTypeList")));
                            ...
                            switch (building)
                            {
                                ...
                                case "Apartment":
                                    IWebElement apartmentType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act1 = new Actions(driver);
                                    act1.MoveToElement(apartmentType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Bed and Breakfast":
                                    IWebElement bedAndBreakfastType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act2 = new Actions(driver);
                                    act2.MoveToElement(bedAndBreakfastType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Boutique Hotel":
                                    IWebElement boutiqueType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act3 = new Actions(driver);
                                    act3.MoveToElement(boutiqueType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Bungalow":
                                    ...
                                    act4.MoveToElement(bungalow).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                    var selectedBungalow = new SelectElement(bungalow);
                                ...
                                case "Camping Ground":
                                    IWebElement campingGroundType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act5 = new Actions(driver);
                                    act5.MoveToElement(campingGroundType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Chalet":
                                    IWebElement chaletType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act6 = new Actions(driver);
                                    act6.MoveToElement(chaletType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Cottage":
                                    IWebElement cottageType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act7 = new Actions(driver);
                                    act7.MoveToElement(cottageType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Farm":
                                    ...
                                    act8.MoveToElement(farmType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Guesthouse":
                                    IWebElement guestHouseType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act9 = new Actions(driver);
                                    act9.MoveToElement(guestHouseType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Home":
                                    ...
                                    act10.MoveToElement(homeType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Homestay":
                                    IWebElement homestayType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act11 = new Actions(driver);
                                    act11.MoveToElement(homestayType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Luxury Yacht":
                                    IWebElement luxuryYachtType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act12 = new Actions(driver);
                                    act12.MoveToElement(luxuryYachtType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Resort":
                                    IWebElement resortType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act13 = new Actions(driver);
                                    act13.MoveToElement(resortType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Serviced Apartment":
                                    IWebElement serviceApptType = waiting.Until(x => x.FindElement(By.Id("FloorPlanTypeList")));
                                    var act14 = new Actions(driver);
                                    act14.MoveToElement(serviceApptType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                                ...
                                case "Villa":
                                    ...
                                    act15.MoveToElement(villaType).Click(driver.FindElement(By.XPath("//*[@id='FloorPlanTypeList']"))).Build().Perform();
                                    Thread.Sleep(800);
                            ...
                            switch (rooms)
                            {
                                ...
                                case "1":
                                    ...
                                    act.MoveToElement(oneBedroom).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "2":
                                    ...
                                    var act2 = new Actions(driver);
                                    act2.MoveToElement(twoBedroom).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "3":
                                    IWebElement threeBedroom = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act3 = new Actions(driver);
                                    act3.MoveToElement(threeBedroom).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "4":
                                    IWebElement fourBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act4 = new Actions(driver);
                                    act4.MoveToElement(fourBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "5":
                                    IWebElement fiveBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act5 = new Actions(driver);
                                    act5.MoveToElement(fiveBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "6":
                                    IWebElement sixBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act6 = new Actions(driver);
                                    act6.MoveToElement(sixBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "7":
                                    IWebElement sevenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act7 = new Actions(driver);
                                    act7.MoveToElement(sevenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "8":
                                    IWebElement eigthBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act8 = new Actions(driver);
                                    act8.MoveToElement(eigthBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "9":
                                    IWebElement nineBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act9 = new Actions(driver);
                                    act9.MoveToElement(nineBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "10":
                                    IWebElement tenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act10 = new Actions(driver);
                                    act10.MoveToElement(tenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "11":
                                    IWebElement elevenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act11 = new Actions(driver);
                                    act11.MoveToElement(elevenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "12":
                                    IWebElement twelveBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act12 = new Actions(driver);
                                    act12.MoveToElement(twelveBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "13":
                                    IWebElement thirteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act13 = new Actions(driver);
                                    act13.MoveToElement(thirteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "14":
                                    IWebElement fourteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act14 = new Actions(driver);
                                    act14.MoveToElement(fourteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "15":
                                    IWebElement fifteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act15 = new Actions(driver);
                                    act15.MoveToElement(fifteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "16":
                                    IWebElement sixteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act16 = new Actions(driver);
                                    act16.MoveToElement(sixteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "17":
                                    IWebElement seventeenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act17 = new Actions(driver);
                                    act17.MoveToElement(seventeenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "18":
                                    IWebElement eighteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act18 = new Actions(driver);
                                    act18.MoveToElement(eighteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "19":
                                    IWebElement nineteenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act19 = new Actions(driver);
                                    act19.MoveToElement(nineteenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "20":
                                    IWebElement twentyBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act20 = new Actions(driver);
                                    act20.MoveToElement(twentyBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "21":
                                    IWebElement twentyOneBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act21 = new Actions(driver);
                                    act21.MoveToElement(twentyOneBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "22":
                                    IWebElement twentyTwoBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act22 = new Actions(driver);
                                    act22.MoveToElement(twentyTwoBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "23":
                                    IWebElement twentyThreeBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act23 = new Actions(driver);
                                    act23.MoveToElement(twentyThreeBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "24":
                                    IWebElement twentyFourBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act24 = new Actions(driver);
                                    act24.MoveToElement(twentyFourBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "25":
                                    IWebElement twentyFiveBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act25 = new Actions(driver);
                                    act25.MoveToElement(twentyFiveBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "26":
                                    IWebElement twentySixBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act26 = new Actions(driver);
                                    act26.MoveToElement(twentySixBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "27":
                                    IWebElement twentySevenBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act27 = new Actions(driver);
                                    act27.MoveToElement(twentySevenBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "28":
                                    IWebElement twentyEightBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act28 = new Actions(driver);
                                    act28.MoveToElement(twentyEightBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "29":
                                    IWebElement twentyNineBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act29 = new Actions(driver);
                                    act29.MoveToElement(twentyNineBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
                                ...
                                case "30":
                                    IWebElement thirtyBedrooms = waiting.Until(x => x.FindElement(By.Id("BedroomsDropDown")));
                                    var act30 = new Actions(driver);
                                    act30.MoveToElement(thirtyBedrooms).Click(driver.FindElement(By.XPath("//*[@id='BedroomsDropDown']"))).Build().Perform();
                                    Thread.Sleep(1000);
